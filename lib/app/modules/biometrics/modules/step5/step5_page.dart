...
class BiometricsStep5Page extends GetView<BiometricsController> {
  const BiometricsStep5Page({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            controller.pet.type == PetType.dog
                ? SvgPicture.asset(
                    'assets/onboarding_biometric/dog4.svg',
                    width: double.infinity,
                    height: 210,
                  )
                : SvgPicture.asset(
                    'assets/onboarding_biometric/cat4.svg',
                    width: double.infinity,
                    height: 210,
                  ),
