...
class ReforceCardMedicament extends StatelessWidget {
  final MedicamentResponse medicament;
  const ReforceCardMedicament({
    super.key,
          ...
          children: [
            Row(
              children: [
                ...
                Flexible(
                  child: Text(
                    'Atualize o histórico de medicamentos',
            ...
            Text(
              formatDayMonthYear(medicament.reforce),
              style: AppTextStyles.poppinsSemiBold(
                      color: AppColors.background, fontSize: 12)
                  .style,
            ),
