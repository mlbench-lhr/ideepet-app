...
class EditPersonalityPage extends GetView<EditPetController> {
                            ...
                            () {
                              ...
                              return CustomButtonSelect(
                                ...
                                action: () {
                                  if (isSelected) {
                                    controller
                                        .removePersonalityInList(personality);
                                  } else {
                                    controller
                                        .addPersonalityInList(personality);
                                  }
                                },
                              );
                            },
